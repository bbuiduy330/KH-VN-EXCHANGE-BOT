...
const inMemoryStore = {
  ...
  broadcastCampaigns: new Map<string, any>(),
  broadcastRecipients: new Map<string, any>(),
...
const mockMap: Record<string, { store: Map<string, any>; key: string }> = {
  ...
  broadcastCampaign: { store: inMemoryStore.broadcastCampaigns, key: "id" },
  broadcastRecipient: { store: inMemoryStore.broadcastRecipients, key: "id" },
...
try {
  ...
  prismaClientInstance = {
    ...
    broadcastCampaign: createMockCollection(inMemoryStore.broadcastCampaigns, "id"),
    broadcastRecipient: createMockCollection(inMemoryStore.broadcastRecipients, "id"),
